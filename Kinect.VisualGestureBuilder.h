...
#ifndef __IGestureResult_FWD_DEFINED__
#define __IGestureResult_FWD_DEFINED__
typedef interface IGestureResult IGestureResult;

#endif 	/* __IGestureResult_FWD_DEFINED__ */
...
#endif // _GestureType_
#ifndef _InvalidTrackingId_
#define _InvalidTrackingId_
typedef enum _InvalidTrackingId InvalidTrackingId;


enum _InvalidTrackingId
    {
        InvalidTrackingId_value	= 0
    } ;
#endif // _InvalidTrackingId_
...
#ifndef __IGestureResult_INTERFACE_DEFINED__
#define __IGestureResult_INTERFACE_DEFINED__

/* interface IGestureResult */
/* [object][local][uuid] */ 


EXTERN_C const IID IID_IGestureResult;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("9D432B72-2193-4534-AA2C-BA730C43AB7B")
    IGestureResult : public IUnknown
    {
    public:
    };
    ...
    typedef struct IGestureResultVtbl
    {
        BEGIN_INTERFACE
    ...
    interface IGestureResult
    {
        CONST_VTBL struct IGestureResultVtbl *lpVtbl;
    };
...
#define IGestureResult_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IGestureResult_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IGestureResult_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 
...
#endif 	/* __IGestureResult_INTERFACE_DEFINED__ */
...
EXTERN_C const IID IID_IDiscreteGestureResult;
    ...
    IDiscreteGestureResult : public IGestureResult
    {
    public:
...
EXTERN_C const IID IID_IContinuousGestureResult;
    ...
    IContinuousGestureResult : public IGestureResult
    {
    public:
...
EXTERN_C const IID IID_IVisualGestureBuilderFrame;
    ...
    {
    public:
        virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_GestureResult( 
            /* [annotation][in] */ 
            _In_  IGesture *gesture,
            /* [annotation][out][retval] */ 
            _COM_Outptr_  IGestureResult **result) = 0;
    ...
    typedef struct IVisualGestureBuilderFrameVtbl
    {
        ...
        /* [propget] */ HRESULT ( STDMETHODCALLTYPE *get_GestureResult )( 
            IVisualGestureBuilderFrame * This,
            /* [annotation][in] */ 
            _In_  IGesture *gesture,
            /* [annotation][out][retval] */ 
            _COM_Outptr_  IGestureResult **result);
...
#define IVisualGestureBuilderFrame_get_GestureResult(This,gesture,result)	\
    ( (This)->lpVtbl -> get_GestureResult(This,gesture,result) ) 
